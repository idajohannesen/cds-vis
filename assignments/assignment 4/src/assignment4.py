...
def face_detection(subfolders, filepath, mtcnn):
    """
    Detect how many faces there are on every page and create a csv file with the data
    """
...
def group_by_decade():
    """
    Group the data by decade, calculate the total number of faces per decade, calculate the percentage of pages with a face present. Add this to a csv file.
    """
...
def plot():
    """
    Plot the percentage of pages with a face detected per decade. Repeat for all 3 newspapers
    """
